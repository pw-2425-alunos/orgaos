...
urlpatterns = [
    ...
    path('compositores/novo', views.criar_compositor_view, name='criar_compositor'),
    path('compositores/<int:id>', views.compositor_view, name="compositor"),
    path('compositores/<int:id>/editar', views.editar_compositor_view, name='editar_compositor'),
